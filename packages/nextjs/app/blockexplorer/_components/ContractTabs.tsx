...
export const ContractTabs = ({ address, contractData }: PageProps) => {
  ...
  useEffect(() => {
    const checkIsContract = async () => {
      const contractCode = await publicClient.getBytecode({ address: address as Hex });
  ...
  return (
    <>
      ...
      {activeTab === "storage" && <AddressStorageTab address={address as Hex} />}
      {activeTab === "logs" && <AddressLogsTab address={address as Hex} />}
    </>
  );
};
