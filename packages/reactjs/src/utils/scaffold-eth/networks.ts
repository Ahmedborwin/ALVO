...
const getAlchemyHttpUrl = (chainId: number) => {
 ...
 */
function getBlockExplorerTxLink(chainId: number, txnHash: string) {
 ...
 */
function getBlockExplorerAddressLink(network: chains.Chain, address: string) {
 ...
 */
function getTargetNetworks(): ChainWithAttributes[] {
